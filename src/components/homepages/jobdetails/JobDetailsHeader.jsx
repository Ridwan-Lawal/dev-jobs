...
function JobDetailsHeader({
  ...
  return (
    <div className="flex flex-col tablet:flex-row rounded-md shadow-lg shadow-blue-50 bg-white -mt-8 tablet:-mt-16 tablet:overflow-hidden  tablet:pr-8  gap-5 items-center tablet:items-stretch ">
      <section
      ...
      <div className="flex flex-col tablet:flex-row items-center gap-10 tablet:justify-between border tablet:py-10 w-full pb-6 md:pb-10">
